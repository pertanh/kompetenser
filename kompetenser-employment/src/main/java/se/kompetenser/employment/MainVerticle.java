...
import se.kompetenser.handlers.EmploymentHandler;
...
public class MainVerticle extends AbstractVerticle {
	...
	private void startup(Promise<Void> startPromise, JsonObject config) {
		...
		EmploymentHandler employmentHandler = new EmploymentHandler(client);
		...
		router.get("/api/kompetenser/employees").handler(employmentHandler::findAll);
		router.get("/api/kompetenser/employees/:companyId/:start/:count").handler(employmentHandler::getByCompanyId);
