...
import se.kompetenser.handlers.CityHandler;
...
public class MainVerticle extends AbstractVerticle {
	...
	private void startup(Promise<Void> startPromise, JsonObject config) {
		...
		CityHandler cityHandler = new CityHandler(client);
		...
		router.get("/api/kompetenser/cities").handler(cityHandler::findAll);
		router.get("/api/kompetenser/cities/:name").handler(cityHandler::findCity);
